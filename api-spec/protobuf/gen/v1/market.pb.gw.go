...
func request_Market_ListMarketIDs_0(ctx context.Context, marshaler runtime.Marshaler, client MarketClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Market_ListMarketIDs_0(ctx context.Context, marshaler runtime.Marshaler, server MarketServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListMarketIDsRequest
	var metadata runtime.ServerMetadata
...
func RegisterMarketHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MarketServer) error {
	...
	mux.Handle("POST", pattern_Market_ListMarketIDs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/tdexa.v1.Market/ListMarketIDs", runtime.WithHTTPPathPattern("/v1/markets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Market_ListMarketIDs_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Market_ListMarketIDs_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMarketHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MarketClient) error {
	...
	mux.Handle("POST", pattern_Market_ListMarketIDs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/tdexa.v1.Market/ListMarketIDs", runtime.WithHTTPPathPattern("/v1/markets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Market_ListMarketIDs_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Market_ListMarketIDs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "markets"}, ""))
)

var (
	forward_Market_ListMarketIDs_0 = runtime.ForwardResponseMessage
)
